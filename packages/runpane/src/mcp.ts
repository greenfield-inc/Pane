...
const INSTRUCTIONS = [
  ...
  '- For the common jobs, prefer the composite tools: `agents_start` starts an agent on a task in a repo and returns its pane and panel ids and a pane:// link; `agents_status` checks on it; `agents_send` sends it a follow-up.',
