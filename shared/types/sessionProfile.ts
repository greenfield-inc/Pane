...
Commands include repos list, panes list/create, panels list/screen/wait/submit, and sessions list/get/overview/update/associate/detach. Worktrees belong to Panes; panels share their Pane's worktree.
