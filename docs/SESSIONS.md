...
directly, and reopening a file restores its tab. The title strip can be dragged
between controls; its drag area leaves both sidebar toggle buttons clickable.
