...
function compareAgentContextParity() {
  ...
  assert.ok(managedBlock.includes('[Pane repository](https://github.com/greenfield-inc/Pane)'));
  ...
  assert.ok(managedBlock.includes('[greenfield-inc/skills](https://github.com/greenfield-inc/skills)'));
  assert.ok(managedBlock.includes('<PANE_DIR>/skills/docs/readme-workflow-map.png'));
  ...
  assert.ok(managedBlock.includes('[PR #291](https://github.com/greenfield-inc/Pane/pull/291)'));
  ...
  assert.ok(managedBlock.includes('inspect upstream skill files with `gh` against [greenfield-inc/skills](https://github.com/greenfield-inc/skills)'));
  assert.ok(managedBlock.includes('prefer the local cache'));
