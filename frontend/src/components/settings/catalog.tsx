...
export const SETTINGS_CATEGORIES: readonly SettingsCategoryDefinition[] = [
  ...
  },
  {
    ...
    icon: Keyboard,
    settingIds: ['keyboard-shortcuts', 'command-palette-shortcut', 'keyboard-shortcut-profile', 'keyboard-shortcut-map', 'kitty-keyboard', 'terminal-shortcuts'],
    aliases: ['hotkeys', 'keyboard', 'keybindings', 'keybinding', 'rebind', 'remap', 'agent shortcut', 'snippets', 'kitty', 'key reporting', 'profile', 'keymap', 'superset'],
  },
  {
    id: 'privacy',
    label: 'Privacy',
